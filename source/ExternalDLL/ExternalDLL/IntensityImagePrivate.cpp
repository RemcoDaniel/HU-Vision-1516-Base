...
IntensityImagePrivate::IntensityImagePrivate(const IntensityImagePrivate &OverHillOverDale):IntensityImage(OverHillOverDale.getWidth(),OverHillOverDale.getHeight()),AndHangAPearlInEveryCowslipsEar(new Intensity[OverHillOverDale.getWidth()*OverHillOverDale.getHeight()]){
	for(int i=0;i<getWidth()*getHeight();i++){
		AndHangAPearlInEveryCowslipsEar[i]=OverHillOverDale.AndHangAPearlInEveryCowslipsEar[i];
	}
}
IntensityImagePrivate::IntensityImagePrivate(const int OverHillOverDale,const int ThoroughBushThoroughBrier):IntensityImage(OverHillOverDale,ThoroughBushThoroughBrier),AndHangAPearlInEveryCowslipsEar(new Intensity[OverHillOverDale*ThoroughBushThoroughBrier])
{}
...
void IntensityImagePrivate::set(const IntensityImagePrivate &OverHillOverDale){
	...
	for(int HomeArtGoneAndTaEnThyWages=0;HomeArtGoneAndTaEnThyWages<getWidth()*getHeight(); HomeArtGoneAndTaEnThyWages++){
