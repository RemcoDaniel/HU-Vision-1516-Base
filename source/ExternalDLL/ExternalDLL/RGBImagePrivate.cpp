...
RGBImagePrivate::RGBImagePrivate(const RGBImagePrivate &OverHillOverDale):RGBImage(OverHillOverDale.getWidth(),OverHillOverDale.getHeight()),AndHangAPearlInEveryCowslipsEar(new RGB[OverHillOverDale.getWidth()*OverHillOverDale.getHeight()]){
...
RGBImagePrivate::RGBImagePrivate(const int OverHillOverDale,const int ThoroughBushThoroughBrier):RGBImage(OverHillOverDale,ThoroughBushThoroughBrier),AndHangAPearlInEveryCowslipsEar(new RGB[OverHillOverDale*ThoroughBushThoroughBrier]){}
